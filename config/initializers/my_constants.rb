...
SERVICE_CATEGORIES = HashWithIndifferentAccess.new(
  ...
  "Адвокаты": [
    ...
    "Бизнес, Финансы, Банкроство", "Паралигалы", "Иммиграция", "Криминал",
  ...
  "Медицина": [
    "Медисцинский офис, Госптиаль", "Аптеки", "Альтернативная медицина",
    "Ветеринарные клиники", "Стоматолог"
  ],
  "Образование": [
    "Университеты, Колледжы, Школы", "Танцы, Музыка, Искусство", "Детские сады",
  ...
  "Строительные работы": [
    ...
    "Снос зданий, Мусор", "Ремонт, Архитектура, Дизайн", "Мастер на все руки",
    "Кондициоры, Отоплние", "Изготовление мебели", "Строительные компании"
  ],
  "Другие Услуги": [
    "Реклама и PR",
    "Туристические фирмы", "Уборка помещений", "Посылки, грузы", "Перевозки",
    "Фото, Видео", "Цветы",
