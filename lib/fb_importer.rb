...
class FbImporter
  ...
  JOBS = [
    ...
    { id: 137863963079459, model: "Job", state_id: 9, city_id: 3964 },
    { id: 778710555550702, model: "Job", state_id: 9, city_id: 3964 },
    { id: 897633366949647, model: "Job", state_id: 9, city_id: 3964 },
    { id: 249106225164786, model: "Job", state_id: 5, city_id: 2302 },
    { id: 926513640746980, model: "Job", state_id: 5, city_id: 1685 },
    { id: 1609170409313852, model: "Job", state_id: 5, city_id: 1884 },
    { id: 1400977150209237, model: "Job", state_id: 47, city_id: 27588 },
    { id: 1106107669412708, model: "Job", state_id: 43, city_id: 24757 },
    { id: 398984013638015, model: "Job", state_id: 3, city_id: 1416 }, # poenix
    { id: 323815354415874, model: "Job", state_id: 9, city_id: 3917 },
    { id: 916738071690195, model: "Job", state_id: 51, city_id: 29723 },
