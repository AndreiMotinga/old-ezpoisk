...
class NewsImporter
  ...
  def self.links
    [
      ...
      # ["http://rss.cnn.com/rss/edition_us.rss", "usa"],
      ...
      ["http://feeds.abcnews.com/abcnews/usheadlines", "usa"],
      ...
      ["http://feeds.foxnews.com/foxnews/national", "usa"],
      ...
      ["http://rss.nytimes.com/services/xml/rss/nyt/US.xml", "usa"],
