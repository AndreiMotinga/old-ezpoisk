$(document).ready(function(){
  ...
  $("#partner_title").on("change keyup paste", function(){
    ...
    $("label[for=partner_title]").html("Title " + (45 - new_title.length));
  });
  ...
  $("#partner_headline").on("change keyup paste", function(){
    ...
    desc.html(new_desc);
    $("label[for=partner_headline]").html("Headline " + (45 - new_desc.length));
  });
  ...
  $("#partner_subline").on("change keyup paste", function(){
    ...
    var new_desc = $(this).val();
    desc.html(new_desc);
    $("label[for=partner_subline]").html("Subline " + (45 - new_desc.length));
  });
  ...
  $("#partner_description").on("change keyup paste", function(){
    ...
    var new_desc = $(this).val();
    desc.html(new_desc);
    $("label[for=partner_description]").html("Description " + (45 - new_desc.length));
  });
